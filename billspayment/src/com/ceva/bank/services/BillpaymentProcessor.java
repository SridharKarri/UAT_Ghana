...
@Component("billpaymentProcessor")
public class BillpaymentProcessor {

	public static final Logger logger = Logger.getLogger(BillpaymentProcessor.class);
	
	private static String appId = ConfigLoader.convertResourceBundleToMap("config").get("bank.account.appid");
	private static String appKey = ConfigLoader.convertResourceBundleToMap("config").get("bank.account.appKey");
