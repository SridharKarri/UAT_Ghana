...
public class PackageFormItem {
	...
	@Column(name="FRFORM_ITEMS")
	private String frformItems;
	...
	public String getFrformItems() {
		return frformItems;
	}

	public void setFrformItems(String frformItems) {
		this.frformItems = frformItems;
	}
