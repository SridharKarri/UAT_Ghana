...
public class BillerPackages {
	...
	@Column(name="FRDISPLAYNAME")
	private String frDisplayName;
	...
	public String getFrDisplayName() {
		return frDisplayName;
	}

	public void setFrDisplayName(String frDisplayName) {
		this.frDisplayName = frDisplayName;
	}
