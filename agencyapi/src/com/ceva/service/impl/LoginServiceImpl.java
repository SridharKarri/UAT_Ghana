...
public class LoginServiceImpl implements LoginService {
	...
	public ResponseDTO changePwd(ChangePin bean) {
		log.info("user changing transaction pin.");
		return loginDao.changePwd(bean);
	}

	@Override
	public ResponseDTO updateProfile(UserLoginCredentials bean) {
		log.info("update user Profile.");
		return loginDao.updateProfile(bean);
	}

	@Override
	public ResponseDTO registerDevice(DeviceRegister bean) {
		log.info("registerDevice Profile.");
		LoginResponse loginResponse = null;
		Merchant merchant=null;
		ResponseDTO responseDTO = loginDao.registerDevice(bean);
		log.debug("got resposne from dao.");
		if(Constants.SUCESS_SMALL.equals(responseDTO.getMessage())){
			log.debug("sucess response from dao.");
			...
			log.info("failure response from dao layer..");
		}
	...
	public ResponseDTO updateProfilePicture(Map<String, Object> map) {
		...
		return loginDao.updateProfilePicture(map);
	}
