...
public interface Constants {
	...
	//public String SYMETRICKEY_ALG = "AES/CBC/PKCS5Padding";
	public String KEYFACTORY_ALG = "RSA";
	public final String SECURE_DATA = "secureData";
	public final String CHANNEL_DATA = "channelData";
	static final String[] ANDROID_END_POINTS = { "cities", "states", "openaccount", "loadparameters", "getAll",
			"loadbranches", "loadcountries", "loadstates", "loadcities", "appVersion", "loadidcate", "loadidtypebycate",
			"loadnationalities", "loadmaritalstatuses", "echo", "location", "loadoccupations", "loadsalutations",
			"createaccount" };
