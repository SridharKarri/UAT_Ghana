...
*/
    	...
    	byte[] key = AESCBCEncryption.base64Decode("EHxxOa9FpK256bvlaICg2bYVsxKodO4XekhsJEdNzaE=");
    	byte[] iv =  AESCBCEncryption.base64Decode("Uj6rU8Owy62PsWskFlv1oQ==");;
    	JSONObject object = new JSONObject();
    	object.put("channel", "3");
    	object.put("userId", "SURESHD");
    	//object.put("bvnNumber", "87878");
    	String encrypted = encrypt(key, iv, object.toString());
