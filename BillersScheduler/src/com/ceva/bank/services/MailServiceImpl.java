	...
	public boolean sendMail(final AbstractVO commonObject) throws MailException {
		...
		preparator = new MimeMessagePreparator() {
			public void prepare(MimeMessage mimeMessage)
				...
				MailServiceImpl.this.log.debug("Inside prepare : " + mimeMessage);
				...
				MailServiceImpl.this.log.debug("from address..:" + commonObject.getSenderEmailAddress());
				MailServiceImpl.this.log.debug("To address..:" + commonObject.getToAddress());
				MailServiceImpl.this.log.debug("After Setting From to ...... mime message Helper");
				...
				if(fileMul != null && fileMul.length>0){
					MailServiceImpl.this.log.info("Adding Attachment..!");
