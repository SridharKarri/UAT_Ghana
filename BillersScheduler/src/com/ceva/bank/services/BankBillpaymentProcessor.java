...
public class BankBillpaymentProcessor
{
	...
	private JSONObject callHttpsService(Object object, String requesturl) {
		...
		logger.info("Entered in HttpsService Method");
		HttpsURLConnection con = null;
		JSONObject response = null;
		String resp = null;
		try {
			String requestBody = includeCerts(object);
			logger.info("HttpsService requestBody : "+requestBody+", requesturl : "+requesturl);
			...
			logger.info("Connection Connecting with appId : "+appId+", appKey : "+appKey);
			...
			logger.info("Connection Connecting with requestBody : "+requestBody);
			...
			resp = bytesOutputStream.toString();
			response = JSONObject.fromObject(resp);
			logger.info("After Successfull Response : "+response);
